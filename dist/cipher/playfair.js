...
exports.findType = exports.types = exports.playfair = exports.originalString = exports.cipherString = undefined;
...
const toChars = secret => {
  const schars = secret.toUpperCase().split('').filter(_util.isUpperCase);

  for (let i = 0, offset = (0, _util.codeOf)('A'); i < 26; i += 1) {
...
const playfair = (secret, input) => {
  ...
  const inputs = input.toUpperCase().replace(/J/g, 'I').split('').filter(_util.isUpperCase);
...
exports.originalString = originalString;
